...
from exports.export.exporters import Exporter, apply_supported_whitelist
from exports.options import list_profiles
...
class GNUARMEclipse(Exporter):
    ...
    def generate(self):
        ...
        for id in profile_ids:
            ...
            # all tools and a specific category for each of the exports.
            opts = {}
            opts['common'] = {}
            opts['as'] = {}
            opts['c'] = {}
   ...
   # -------------------------------------------------------------------------
    ...
    def compute_exclusions(self):
        ...
        # terrylee
        # self.excluded_folders.append("rabbit/bsp")
        # self.excluded_folders.append("rabbit/doc")
        # self.excluded_folders.append("rabbit/exports")
        # self.excluded_folders.append("rabbit/tool")
        # self.excluded_folders.append("rabbit/ucosii")
        # self.excluded_folders.append("rabbit/drv/cmsis")
        # self.excluded_folders.append("rabbit/prj/Eval")
        # self.excluded_folders.append("rabbit/prj/testbench")
    ...
    def process_options(self, opts, flags_in):
        ...
        # terrylee do not need to -include'xxx.h'
        #include_files = ['./rabbit/prj_demo/examples/acmp/config.h'] 
