...
from exports.toolchains import Resources
from exports.export import lpcxpresso, ds5_5, iar, makefile
from exports.export import embitz, coide, kds, simplicity, atmelstudio
from exports.export import sw4stm32, e2studio, zip, cmsis, uvision, cdt, vscode
from exports.export import gnuarmeclipse
from exports.export import qtcreator
...
EXPORTERS = {
    ...
    'GreeIDE': gnuarmeclipse.GNUARMEclipse,
...
def get_exporter_toolchain(ide):
    ...
    """
    varli = EXPORTERS[ide]
    varli2 = EXPORTERS[ide].TOOLCHAIN
