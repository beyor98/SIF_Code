...
from exports.targets.LPC import patch
from exports.paths import TOOLS_BOOTLOADERS
from exports.utils import json_file_to_dict
...
class NCS36510TargetCode:
    ...
    def ncs36510_addfib(t_self, resources, elf, binf):
        from exports.targets.NCS import add_fib_at_start
        print("binf ", binf)
...
class RTL8195ACode:
    ...
    @staticmethod
    def binary_hook(t_self, resources, elf, binf):
        from exports.targets.REALTEK_RTL8195AM import rtl8195a_elf2bin
