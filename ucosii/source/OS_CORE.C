...
* Returns    : none
*
* Note(s)    : ) OSTaskIdleHook() is called after the critical section to ensure that interrupts will be
...
*                                         OSIdleCtrMax
*
* Arguments  : pdata     this pointer is not used at this time.		   56+4
*
* Returns    : none
*
