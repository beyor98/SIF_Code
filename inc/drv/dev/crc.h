...
typedef enum    
{
    ...
    INPUT_FORMAT_HALFWORDS                        ,   /**< The inputdata are 16 bits lenght */
    INPUT_FORMAT_WORDS                                /**< The inputdata are 32 bits lenght */
} CRC_InputFormat_T;
...
typedef enum  
{
    ...
    INPUT_INVERSION_BY_BYTE                       ,  /**< inputdata 8bit as uint to inversion */
    INPUT_INVERSION_BY_HALFWORD                   ,  /**< inputdata 16bit as uint to inversion */
    INPUT_INVERSION_BY_WORD                          /**< inputdata 32bit as uint to inversion */
...
typedef enum  
{
    ...
    CRC_POLYLENGTH_16B 						      , /**< polynomial bitwidth 16bit(crc16) */  
    CRC_POLYLENGTH_32B 						      , /**< polynomial bitwidth 32bit(crc32) */ 
    CRC_POLYLENGTH_7B  						        /**< polynomial bitwidth 7bit(crc7) */
} CRC_PolyLength_T;
