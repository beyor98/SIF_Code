...
#define CLOCK_MASK_SYSCLK          (0x01)     /**< System clock mask*/
     ...
     defined (CHIP_GM6621) || defined (CHIP_GM6611B) || defined(CHIP_F6601C))
...
#define UART1_CLOCK_PLL6XBY26      (0x0) /**< UART1 clock is derived from PLL6x divided by 26 */
#define UART1_CLOCK_PLL6X          (0x1) /**< UART1 clock is derived from PLL6x */

#define UART0_CLOCK_PLL6XBY26      (0x0) /**< UART0 clock is derived from PLL6x divided by 26 */
#define UART0_CLOCK_PLL6X          (0x1) /**< UART0 clock is derived from PLL6x */
...
#define LIRC32K_SOURCE_STABLE_MASK  ((uint32_t)(1 << LIRC32K_SOURCE_STABLE_POS))  /**< IRC 32KHz stable mask */
...
#define ADC_CLOCK_512KHZ           (95) /**< ADC clock is 512KHz */
#define ADC_CLOCK_1MHZ             (47) /**< ADC clock is 1MHz */
#define ADC_CLOCK_2MHZ             (23) /**< ADC clock is 2MHz */
#define ADC_CLOCK_4MHZ             (11) /**< ADC clock is 4MHz */
#define ADC_CLOCK_8MHZ             (5) /**< ADC clock is 8MHz */
#define ADC_CLOCK_16MHZ            (2) /**< ADC clock is 16MHz */
#define ADC_CLOCK_24MHZ            (1) /**< ADC clock is 24MHz */
#endif
...
#define CALENDAR_CLOCK_FCLK        (0x0)
#define CALENDAR_CLOCK_LOSC        (0x1)
#define CALENDAR_CLOCK_LIRC        (0x2)
#define CALENDAR_CLOCK_HIRC        (0x3)
#define CALENDAR_CLOCK_HOSC        (0x4)
...
#define CLOCK_SEL2_LCD_MASK        ((uint32_t)(3 << CLOCK_SEL2_LCD_POS)) /**< LCD bitfield mask */
#if defined (CHIP_GM6611B)
...
#define CLOCK_PERIPH_LVD_MASK       ((uint32_t)(0x00000800)) /**< Peripheral clock masked for LVD */
#define CLOCK_PERIPH_ACMP_MASK      ((uint32_t)(0x00001000)) /**< Peripheral clock masked for ACMP */
#define CLOCK_PERIPH_LCD_MASK       ((uint32_t)(0x00002000)) /**< Peripheral clock masked for LCD */

#define IRTX_CLOCK_FCLK             (0)     /**< IRTX clock is derived from FCLK */
#define IRTX_CLOCK_HIRC             (1)     /**< IRTX clock is derived from HIRC */
#define IRTX_CLOCK_HOSC             (2)     /**< IRTX clock is derived from HOSC */

#define CLOCK_SET_UNLOCK            IO_BITS_SET(SYSDEV->WDTC,WDOG_UNLOCK_MAGIC_NUM)
#define CLOCK_SET_LOCK              IO_BITS_SET(SYSDEV->WDTC,0)

#define WDT_CLOCK_LIRC              (0)     /**< WDT clock is derived from LIRC */
#define WDT_CLOCK_LOSC              (1)     /**< WDT clock is derived from LOSC */
#define WDT_CLOCK_HIRC              (2)     /**< WDT clock is derived from HIRC */

#define ADC_CLOCK_FCLK              (0)     /**< ADC clock is derived from FCLK */
#define ADC_CLOCK_HIRC              (1)     /**< ADC clock is derived from HIRC */

#define ADC_CLOCK_DIV_1             (0)     /**< ADC clock divider 1 to FCLK */
#define ADC_CLOCK_DIV_2             (1)     /**< ADC clock divider 2 to FCLK */
#define ADC_CLOCK_DIV_4             (3)     /**< ADC clock divider 4 to FCLK */
#define ADC_CLOCK_DIV_8             (7)     /**< ADC clock divider 8 to FCLK */
#define ADC_CLOCK_DIV_16            (15)    /**< ADC clock divider 16 to FCLK */
#define ADC_CLOCK_DIV_32            (31)    /**< ADC clock divider 32 to FCLK */
#define ADC_CLOCK_DIV_64            (63)    /**< ADC clock divider 64 to FCLK */
#define ADC_CLOCK_DIV_128           (127)   /**< ADC clock divider 128 to FCLK */

#define LPSTM_CLOCK_FCLK            (0)     /**< LPSTM clock is derived from FCLK */
#define LPSTM_CLOCK_LOSC            (1)     /**< LPSTM clock is derived from LOSC */
#define LPSTM_CLOCK_LIRC            (2)     /**< LPSTM clock is derived from LIRC */
#define LPSTM_CLOCK_HIRC            (3)     /**< LPSTM clock is derived from HIRC */

#define RTC0_CLOCK_FCLK             (0)     /**< RTC clock is derived from FCLK */
#define RTC0_CLOCK_LOSC             (1)     /**< RTC clock is derived from LOSC */
#define RTC0_CLOCK_LIRC             (2)     /**< RTC clock is derived from LIRC */
#define RTC0_CLOCK_HIRC             (3)     /**< RTC clock is derived from HIRC */
#define RTC0_CLOCK_HOSC             (4)     /**< RTC clock is derived from HOSC */

#define LVD_CLOCK_LIRC              (0)     /**< LVD clock is derived from LIRC */
#define LVD_CLOCK_LOSC              (1)     /**< LVD clock is derived from LOSC */

#define ACMP_CLOCK_FCLK             (0)     /**< ACMP clock is derived from FCLK */
#define ACMP_CLOCK_LOSC             (1)     /**< ACMP clock is derived from LOSC */
#define ACMP_CLOCK_LIRC             (2)     /**< ACMP clock is derived from LIRC */

#define LCD_CLOCK_CP_LIRC           (0)     /**< LCD CP clock is derived from LIRC */
#define LCD_CLOCK_CP_LOSC           (1)     /**< LCD CP clock is derived from LOSC */

#define LCD_CLOCK_LIRC              (0)     /**< LCD clock is derived from LIRC */
#define LCD_CLOCK_LOSC              (1)     /**< LCD clock is derived from LOSC */
...
#define IRC32K_SOURCE_STABLE_MASK   ((uint32_t)(1 << IRC32K_SOURCE_STABLE_POS))  /**< IRC 32KHz stable mask */
...
#define PLL_REFERENCE_CLOCK_POS     (1)
#define PLL_REFERENCE_CLOCK_MASK    ((uint32_t)(3 << PLL_REFERENCE_CLOCK_POS))  /**< PLL reference clock mask */

#define CLOCK_AOP_SEL1_LVD_POS      (24)
#define CLOCK_AOP_SEL1_LVD_MASK     ((uint32_t)(1 << CLOCK_AOP_SEL1_LVD_POS))   /**< LVD bitfield mask */
#define CLOCK_AOP_SEL2_ACMP_POS     (30)
#define CLOCK_AOP_SEL2_ACMP_MASK    ((uint32_t)(3UL << CLOCK_AOP_SEL2_ACMP_POS))  /**< ACMP bitfield mask */
#define CLOCK_AOP_SEL2_LCD_CP_POS   (8)
#define CLOCK_AOP_SEL2_LCD_CP_MASK  ((uint32_t)(1 << CLOCK_AOP_SEL2_LCD_CP_POS)) /**< LCD charge pump bitfield mask */
#define CLOCK_AOP_SEL2_LCD_SRC_POS  (7)
#define CLOCK_AOP_SEL2_LCD_SRC_MASK ((uint32_t)(1 << CLOCK_AOP_SEL2_LCD_SRC_POS)) /**< LCD Source bitfield mask */
 ...
 * @retval None
 */
#define CLOCK_PERIPH_WDT_CONFIG(WDTCLOCK)     IO_BITMASK_SET(SYSDEV->CLK2,CLOCK_SEL2_WDT_MASK,    \
 ...
 * @retval None
 */
#define CLOCK_PERIPH_LPSTM_CONFIG(LPSTMCLOCK)     IO_BITMASK_SET(SYSDEV->CLK3,CLOCK_SEL3_LPSTM_MASK,    \
...
/**
 * @brief Configure LVD Clock.
 * @param LVD Clock
 * @retval None
 */
#define CLOCK_PERIPH_LVD_CONFIG(LVDCLOCK)       IO_BITMASK_SET(AOPDEV->CSR1,CLOCK_AOP_SEL1_LVD_MASK,    \
        (LVDCLOCK << CLOCK_AOP_SEL1_LVD_POS))

/**
 * @brief Configure ACMP Clock.
 * @param ACMP Clock
 * @retval None
 */
#define CLOCK_PERIPH_ACMP_CONFIG(ACMPCLOCK)       IO_BITMASK_SET(AOPDEV->CSR2,CLOCK_AOP_SEL2_ACMP_MASK,    \
        (ACMPCLOCK << CLOCK_AOP_SEL2_ACMP_POS))

/**
 * @brief Configure LCD charge pump Clock.
 * @param LCD charge pump Clock
 * @retval None
 */
#define CLOCK_PERIPH_LCD_CP_CONFIG(LCDCPCLOCK)       IO_BITMASK_SET(AOPDEV->CSR2,CLOCK_AOP_SEL2_LCD_CP_MASK,    \
        (LCDCPCLOCK << CLOCK_AOP_SEL2_LCD_CP_POS))
 ...
 * @retval None
 */
#define CLOCK_PERIPH_LCD_CONFIG(LCDCLOCK)       IO_BITMASK_SET(AOPDEV->CSR2,CLOCK_AOP_SEL2_LCD_SRC_MASK,    \
        (LCDCLOCK << CLOCK_AOP_SEL2_LCD_SRC_POS))
...
typedef enum
{
    ACMP_CLK_EN         = 0x00002000,  /**< ACMP peripheral Clock Enable */
    ADC_CLK_EN          = 0x00001000,  /**< ADC peripheral Clock Enable */
    ETM_CLK_EN          = 0x00000800,  /**< ETM peripheral Clock Enable */
    DMA_CLK_EN          = 0x00000400,  /**< DMA peripheral Clock Enable */
    SPI_CLK_EN          = 0x00000200,  /**< SPI peripheral Clock Enable */
    GPIO_CLK_EN         = 0x00000040,  /**< GPIO peripheral Clock Enable */
    UART2_CLK_EN        = 0x00000020,  /**< UART2 peripheral Clock Enable */
    UART1_CLK_EN        = 0x00000010,  /**< UART1 peripheral Enable */
    UART0_CLK_EN        = 0x00000008,  /**< UART0 peripheral Enable */
    I2C1_CLK_EN         = 0x00000002,  /**< I2C1 peripheral Enable */
    I2C0_CLK_EN         = 0x00000001,  /**< I2C0 peripheral Enable */
} CLOCK_EnablePeripheralName_T;
#endif
