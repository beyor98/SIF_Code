...
#define GPIOE15_AF1_CANRX       ((uint32_t)0x20000000)  /**< CAN RX alternate function mapping */
#define GPIOE15_AF2_TSTCLK      ((uint32_t)0x40000008)  /**< source clocks output alternate function mapping */

#define GPIOF1_AF2_ETM0CH1      ((uint32_t)0x40000009)  /**< ETMA_CH1 alternate function mapping */
...
#define GPIOF2_AF2_ETM0CH2       ((uint32_t)0x4000000A) /**< ETMA_CH2 alternate function mapping */
...
/** @defgroup FLT_clk_psc_define Filter clock prescler define, removed noise time value is based on the clock of 8MHz or 48MHz.
  * @{
  */
#define  FLT_CLK0_PSC_DIV_2               ((uint32_t)0x00000000)   /**< Divided FILTER clock by 2, removed noise: 500ns (8MHz),83.3ns  (48MHz) */
#define  FLT_CLK0_PSC_DIV_4               ((uint32_t)0x00000001)   /**< Divided FILTER clock by 4, removed noise: 1us   (8MHz),166.7ns (48MHz) */
#define  FLT_CLK0_PSC_DIV_8               ((uint32_t)0x00000002)   /**< Divided FILTER clock by 8, removed noise: 2us   (8MHz),333.3ns (48MHz) */
#define  FLT_CLK0_PSC_DIV_16              ((uint32_t)0x00000003)   /**< Divided FILTER clock by 16, removed noise: 4us  (8MHz),666.7ns (48MHz)*/

#define  FLT_CLK1_PSC_DIV_32              ((uint32_t)0x00000000)   /**< Divided FILTER clock by 32, removed noise: 8us  (8MHz),1.333us (48MHz) */
#define  FLT_CLK1_PSC_DIV_64              ((uint32_t)0x00000001)   /**< Divided FILTER clock by 64, removed noise: 16us (8MHz),2.6667us (48MHz)*/
#define  FLT_CLK1_PSC_DIV_128             ((uint32_t)0x00000002)   /**< Divided FILTER clock by 128, removed noise: 32us(8MHz),5.3333us (48MHz)*/
#define  FLT_CLK1_PSC_DIV_256             ((uint32_t)0x00000003)   /**< Divided FILTER clock by 256, removed noise: 64us(8MHz),10.6667us (48MHz)*/
#define  FLT_CLK1_PSC_DIV_512             ((uint32_t)0x00000004)   /**< Divided FILTER clock by 512, removed noise: 128us (8MHz),21.3333us (48MHz)*/
#define  FLT_CLK1_PSC_DIV_1K              ((uint32_t)0x00000005)   /**< Divided FILTER clock by 1K, removed noise: 256us (8MHz),41.6667us (48MHz) */
#define  FLT_CLK1_PSC_DIV_2K              ((uint32_t)0x00000006)   /**< Divided FILTER clock by 2K, removed noise: 512us (8MHz),83.3333us (48MHz)*/
#define  FLT_CLK1_PSC_DIV_4K              ((uint32_t)0x00000007)   /**< Divided FILTER clock by 4K, removed noise: 1ms (8MHz),166.6666us (48MHz)*/

#define  FLT_CLK2_PSC_DIV_8K              ((uint32_t)0x00000000)   /**< Divided FILTER clock by 8K, removed noise: 2ms (8MHz),333.3333us (48MHz)*/
#define  FLT_CLK2_PSC_DIV_16K             ((uint32_t)0x00000001)   /**< Divided FILTER clock by 16K, removed noise: 4ms (8MHz),666.6667us (48MHz)*/
#define  FLT_CLK2_PSC_DIV_32K             ((uint32_t)0x00000002)   /**< Divided FILTER clock by 32K, removed noise: 8ms (8MHz),1.3333333ms (48MHz)*/
#define  FLT_CLK2_PSC_DIV_64K             ((uint32_t)0x00000003)   /**< Divided FILTER clock by 64K, removed noise: 16ms(8MHz),2.6666667ms (48MHz)*/
...
/**
  ...
  */
#define GPIO_EXTI_GET_IT(pGPIO, exti_line) (pGPIO->ISFR & (exti_line))
...
/**
  ...
  * @retval None
  */
#define GPIO_EXTI_CLEAR_IT(pGPIO, exti_line) (pGPIO->ISFR = (exti_line))
