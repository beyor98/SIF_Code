...
typedef enum
{
    ...
    CAN_NORMAL_MODE,                            /**< CAN workoode is normal mode */
...
typedef struct CAN_Handle
{
    ...
    volatile  uint8_t                             rd;                         /**< Read ringbuf frame index */
    volatile  uint8_t                             wr;                         /**< Write ringbuf frame index */
...
typedef struct
{
    ...
    uint32_t                            filterCode0;                /**< The bit filed in the filtercode0&mask0 is
                                                                         1 means is vaild bit */
    uint32_t                            filterMask0;                /**< The mask value to filterCode0 */
    uint32_t                            filterCode1;                /**< The bit filed in the filterCode0&Mask1 is
                                                                         1 means is vaild bit */
    uint32_t                            filterMask1;                /**< The Mask Value To filterCode1 */
#elif defined(CHIP_GM6611B)
    uint32_t                            filterCode[16];             /**< The bit filed in the filtercode&mask is
                                                                         1 means is vaild bit */
 ...
 * @param hCAN                          Point to the handler.
