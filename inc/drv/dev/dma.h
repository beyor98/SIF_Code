...
typedef struct
{
    ...
    uint32_t            destScatterInterval; /**< DMA dest scatter interval */
    uint32_t            destScatterCount;    /**< DMA dest scatter count */
    uint8_t             pesEnable;           /**< DMA pes mode enable */
    PES_ChannelIndex_T  pesChnIndex;         /**< DMA pes channel index */
#elif defined(CHIP_GM6601) || defined(CHIP_GM6601B) || defined(CHIP_GM6611) || defined(CHIP_GM6611B) || defined(CHIP_F6601C)
