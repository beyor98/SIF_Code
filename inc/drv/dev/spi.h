...
typedef struct __SPI_Handle_T
{
    ...
    uint8_t                 fixedFramesSend;           /**< fixed frames have been send */
    ...
    volatile uint8_t        status;                    /**< Handle Status */
    uint8_t                 dataWidth;                 /**< Bytes of each data frame */
    volatile uint8_t        rxfifoTh;                  /**< receive fifo threshold */
    volatile uint8_t        rcount;                    /**< Received data count */
    volatile uint8_t        tcount;                    /**< Transferred data count */
    uint8_t                 *pTxData;                  /**< Address of remaining data to send. */
    uint8_t                 *pRxData;                  /**< Address of remaining data to receive. */
    volatile uint16_t       rxExpectedSize;           /**< Expected received size */
    volatile uint16_t       txExpectedSize;           /**< Expected transmitted size */
    volatile uint16_t       txSize;                   /**< Size of transmitted data */
    volatile uint16_t       rxSize;                   /**< Size of received data */
 ...
 *                         TIMEOUT_WAIT_FOREVER, TIMEOUT_NO_BLOCKING
...
/**
 * @brief Flush SPI TX and RX FIFO.
 *
 * This function flush spi fifo.
 *
 * @param  hSPI            SPI handle
 *
 * @retval                  None
