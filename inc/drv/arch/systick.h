...
/**
 * Allowed interval between two periodic interrupts or two callbacks
 */
typedef enum 
{
    SYSTICK_1MS   = 1, 	       /**< Default interval(max interval) between two interrupts is 1 millisecond  */
    SYSTICK_500US = 2,         /**< Division factor 2 means interval is 500 microseconds  */   
    SYSTICK_250US = 4,         /**< Division factor 4 means interval is 250 microseconds  */   
    SYSTICK_2MS   = 0x1002,    /**< Callback interval is 2 milliseconds  */   
    SYSTICK_4MS   = 0x1004,    /**< Callback interval is 4 milliseconds  */   
    SYSTICK_8MS   = 0x1008,    /**< Callback interval is 8 milliseconds  */   
} SYSTICK_Interval_T;
...
typedef struct
{
    uint64_t startTime;       /* Start time by millisecond */
...
/**
 * @brief Config and init systick timer.
 */
