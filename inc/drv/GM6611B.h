...
typedef enum IRQn {
    ...
    Calendar_IRQn                = 31,             /**< RTC Calendar interrupt */
} IRQn_Type;
...
#endif
#ifndef Calendar_IRQn_INTVEC
#define Calendar_IRQn_INTVEC            47
#else
#define INTVEC_47  Calendar_IRQn_INTVEC
#endif
