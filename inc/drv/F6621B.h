...
typedef enum IRQn {
    ...
    USART_IRQn                    = 27,             /**< UART0 interrupt */
    //SPI2_IRQn                    = 32,             /**< SPI2 interrupt */
...
#ifndef USART_IRQn_INTVEC
#define USART_IRQn_INTVEC                43
#else
#define INTVEC_43   USART_IRQn_INTVEC
#endif
