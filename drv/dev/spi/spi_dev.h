...
typedef struct
{
    ...
    __IO uint32_t RESV3;              /**< SPI Reserved Registers, offset: 0x24 */
#else
...
#if defined(CHIP_GM6621)||defined(CHIP_F6601C)
    __IO uint32_t RESV4;              /**< SPI Reserved Registers, offset: 0x50 */
#else
    ...
    __IO uint32_t IS;                 /**< SPI Interrupt Status Register, offset: 0x68 */
    __IO uint32_t IE;                 /**< SPI Interrupt Enable Register, offset: 0x6c */
...
#define  SPI_CTRL_FMT                (0x00000006U)            /**< SPI Frame Format Selection, 0: Freescale; 1: TI; 2:  Reserved */
...
#define  SPI_FFCFG_TFTH              (0x0000000FU)           /**< Receive FIFO Threshold  */
#define  SPI_FFCFG_RFTH              (0x000F0000U)           /**< Transmit FIFO Threshhold */
#else
#define  SPI_FFCFG_TFTH              (0x000000FFU)           /**< Receive FIFO Threshold  */
...
#if defined(CHIP_F6601C)
#define  SPI_FFLV_TF                 (0x0000000FU)           /**< Transmit FIFO Level */
#define  SPI_FFLV_RF                 (0x000F0000U)           /**< Receive  FIFO Threshhold */
#else
#define  SPI_FFLV_TF                 (0x000000FFU)           /**< Transmit FIFO Level */
#define  SPI_FFLV_RF                 (0x00FF0000U)           /**< Receive  FIFO Threshhold */
#endif
...
#if defined(CHIP_F6601C)
#define  SPI_RDMA_RTH                (0x000F0000U)           /**< RX DMA Request Threshhold */
#define  SPI_TDMA_TTH                (0x000F0000U)           /**< TX DMA Request Threshhold */
#else
...
/** Base addresses of SPI Control Registers */
#define  SPI0_BASE                   (0x40003000u)

/** SPI Device Pointer */
#define  SPI0                        ((SPI_Device_T *)SPI0_BASE)

/** SPI Device Number */
#define  MAX_SPI_DEVICE              (1U)

/** All SPI Base Addresses */
#define ALL_SPI_DEVICES              SPI0

/** All SPI Interrupts */
#define ALL_SPI_INTERRUPTS           SPI0_IRQn
#endif

#if (defined(CHIP_GM6611) || defined(CHIP_GM6611B)|| defined(CHIP_GM6621))
/** Base addresses of SPI Control Registers */
#define  SPI0_BASE                   (0x40003000u)
#define  SPI1_BASE                   (0x40031000u)

/** SPI Device Pointer */
#define  SPI0                        ((SPI_Device_T *)SPI0_BASE)
#define  SPI1                        ((SPI_Device_T *)SPI1_BASE)

/** SPI Device Number */
#define  MAX_SPI_DEVICE              (2U)

/** All SPI Base Addresses */
#define ALL_SPI_DEVICES              SPI0,SPI1

/** All SPI Interrupts */
#define ALL_SPI_INTERRUPTS           SPI0_IRQn,SPI1_IRQn
