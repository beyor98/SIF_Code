...
/** Base addresses of GPIO Control Registers */
#define GPIOA_BASE       (0x40010000)
#define GPIOB_BASE       (0x40011000)
#define GPIOC_BASE       (0x40012000)
#define GPIOD_BASE       (0x40013000)

#if (defined(CHIP_GM6611) || defined(CHIP_GM6611B))
#define GPIOE_BASE       (0x40014000)
#endif

#if defined(CHIP_GM6611B)
#define GPIOF_BASE       (0x40015000)
#endif
...
#elif (defined(CHIP_GM6611) || defined(CHIP_GM6601B) || defined(CHIP_GM6611B) || defined(CHIP_F6601C))
/** GPIO - Register Layout Typedef */
typedef struct
{
    __IO uint32_t DR;            /**< Offset: 0x0, read: input sampled at pin, write: to data output */
...
typedef struct
{
    ...
    __IO uint32_t IPCR;          /**< External interrupt polarity clear register, offset: 0x34 */
    __IO uint32_t ISFR;          /**< External interrupt status flag register, offset: 0x38 */
    __IO uint32_t RESERVED1[753];/**< Reserved register: 0x40~0xBFC */
