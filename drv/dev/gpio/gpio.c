...
* Static variables
*******************************************************************************/
#if (defined(CHIP_GM6601) || defined(CHIP_GM6621) || defined(CHIP_GM6601B) || defined(CHIP_F6601C))
...
const IRQn_Type s_GPIOIrqs[] = {GPIO0_IRQn, GPIO1_IRQn, GPIO2_IRQn, GPIO3_IRQn};
...
/** @brief Pointers to GPIO IRQ number for each instance. */
const IRQn_Type s_GPIOIrqs[] = {GPIO0_IRQn, GPIO1_IRQn, GPIO2_IRQn, GPIO3_IRQn, GPIO4_IRQn};
...
#if (defined(CHIP_GM6611) || defined(CHIP_GM6601B) || defined(CHIP_GM6611B) || defined(CHIP_F6601C))
...
RET_CODE GPIO_SetPinFilter(GPIO_Pin_T pin, GPIO_InputGlitchFilter_T *pFilter)
{
    ...
    else
    {
        ...
        IO_BITMASK_SET(SYSDEV->DBCS[instance], 0x4, 0x4);
#endif

#if (defined(CHIP_GM6621)) || (defined(CHIP_GM6611B))
        IO_BIT_SET(SYSDEV->CLK2, (1 << 8));
#endif
