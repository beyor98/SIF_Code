...
/* Size per flash in bytes, equals to FLASH_PAGE_SIZE * FLASH_TOTAL_PAGES */
#define FLASH_TOTAL_SIZE               ((uint32_t)0x20000)
#endif
...
#if defined(CHIP_GM6601B) || defined(CHIP_GM6611B)
...
/* One bit indicates 4 pages are locked */
#define FLASH_LOCK_DENSITY             ((uint32_t)(FLASH_PAGE_SIZE * 4))
#endif
...
typedef struct
{
    ...
    __IO uint32_t VER;     /*!< Flash Version Register,     Address offset: 0x48 */
} FLASH_Device_T;
#endif
