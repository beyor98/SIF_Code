...
__Vectors_Size 	EQU     __Vectors_End - __Vectors
                ...
                IF      :LNOT::DEF:RAM_TARGET
					...
					IF      :DEF:GM6601B_FPGA
						;for GM6601B FPGA
						AREA   |.ARM.__at_0x0F0|, CODE, READONLY
						DCB     0x75,       0x43,       0x65,       0x53        ;0x1FFFF0F0, security identify        
						DCB     0x5F,       0x00,       0x55,       0xAA        ;0x1FFFF0F4, watchdog
						DCB     0xFF,       0x00,       0x00,       0x5A        ;0x1FFFF0F8, boot config       
						DCB     0x5A,       0x5A,       0xAA,       0x55 		;0x1FFFF0FC, analog trimming				
					ENDIF
					IF      :DEF:GM6601B_CHIPSET
						;for GM6601B CHIPSET
						AREA   |.ARM.__at_0x600|, CODE, READONLY
						;DCB     0xFF,       0xFE,       0x00,       0xFF        ;0x1FFFF600, boot config, boot from info page
                        ;DCB     0x88,       0xA0,       0x87,       0xc5        ;0x1FFFF604, analog trimming, need match each chipset
...
;label1
				...
				BL LABEL
CLOSE_SWD				
				IF      :DEF:GM6601B_CHIPSET :LOR: :DEF:GM6611B_CHIPSET
	            MOVS R1, #0x5a
				LDR  R2, =0x40000120
				STRB R1, [R2,#8]
                ENDIF
