...
Reset_Handler   PROC
               ...
               ;Copy data to SRAM and then do-remapping
                MOVS  R2, #0x01
...
label1
                ...
                ;Erase all Flash Memory, Code already on SRAM, Just test ...
                ;MOVS  R2, #0x01
                ;MOVS  R0, R2, LSL#30  ; R0 = 0x40000000                
                ;MOVS  R2, #0x01
                ;MOVS  R1, R2, LSL#12  ; R1 = 0x1000                
                ;ADDS  R2, R1, R0      ; R2 = 0x40001000
                
                ;MOVS  R3, #0x01
                ;MOVS  R0, R3, LSL#28  ; R0 = 0x10000000
                ;STR   R0, [R2, #0x0C] ; Flash Physical Address
                
                ;MOVS  R0, 0x21
                ;STRB  R0, [R2, #0x04] ; Issue Mass Iusse
